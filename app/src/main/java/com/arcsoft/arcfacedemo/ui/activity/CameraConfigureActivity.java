...
import com.arcsoft.arcfacedemo.preference.DualCameraOffsetSeekBarPreference;
...
public class CameraConfigureActivity extends BaseActivity implements ViewTreeObserver.OnGlobalLayoutListener, IDualCameraFaceInfoTransformer {
    ...
    public static class DualCameraOffsetPreferenceFragment extends PreferenceFragmentCompat implements Preference.OnPreferenceChangeListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object newValue) {
            ...
            if (preference instanceof DualCameraOffsetSeekBarPreference) {
        ...
        public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
            ...
            DualCameraOffsetSeekBarPreference horizontalOffsetPreference = findPreference(horizontalOffset);
            DualCameraOffsetSeekBarPreference verticalOffsetPreference = findPreference(verticalOffset);
