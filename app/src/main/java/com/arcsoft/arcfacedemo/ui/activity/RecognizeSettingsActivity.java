...
import com.arcsoft.arcfacedemo.ui.preference.ChooseDetectDegreeListPreference;
...
public class RecognizeSettingsActivity extends BaseActivity {
    ...
    public static class SettingsFragment extends RecognizeSettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        ThresholdPreference imageQualityThresholdPreference;
        ...
        private void initPreference() {
            ...
            imageQualityThresholdPreference = findPreference(getString(R.string.preference_image_quality_threshold));
            imageQualityThresholdPreference.setOnPreferenceChangeListener(this);
            ...
            String imageQualityThreshold = String.format("%.2f", ConfigUtil.getImageQualityThreshold(getContext()));
            imageQualityThresholdPreference.setText(imageQualityThreshold);
