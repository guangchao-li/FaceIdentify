...
/**
 * 基于{@link androidx.preference.SeekBarPreference}修改，设置最大值和最小值
 */
public class DualCameraOffsetSeekBarPreference extends Preference {
    private static final int MAX_DUAL_CAMERA_OFFSET = 200;
    private static final int MIN_DUAL_CAMERA_OFFSET = -200;
    ...
    public DualCameraOffsetSeekBarPreference(
        ...
        mMin = MIN_DUAL_CAMERA_OFFSET;
        setMax(MAX_DUAL_CAMERA_OFFSET);
    ...
    public DualCameraOffsetSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public DualCameraOffsetSeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.seekBarPreferenceStyle);
    }

    public DualCameraOffsetSeekBarPreference(Context context) {
        this(context, null);
    }
    ...
    /**
     * Gets whether the {@link DualCameraOffsetSeekBarPreference} should continuously save the {@link SeekBar} value
     ...
     *
     * @return Whether the {@link DualCameraOffsetSeekBarPreference} should continuously save the {@link SeekBar}
    ...
    /**
     * Sets whether the {@link DualCameraOffsetSeekBarPreference} should continuously save the {@link SeekBar} value
     * while it is being dragged.
     *
     * @param updatesContinuously Whether the {@link DualCameraOffsetSeekBarPreference} should continuously save
